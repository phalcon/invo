...
<table class="table table-bordered table-striped" align="center">
    ...
    {% endif %}
        <tr>
            ...
            <td width="12%">{{ link_to("producttypes/edit/" ~ producttype.id, '<i class="icon-pencil"></i> Edit', "class": "btn") }}</td>
            <td width="12%">{{ link_to("producttypes/delete/" ~ producttype.id, '<i class="icon-remove"></i> Delete', "class": "btn") }}</td>
        </tr>
    {% if loop.last %}
    </tbody>
    <tbody>
